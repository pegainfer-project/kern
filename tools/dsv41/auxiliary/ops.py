...
def definitions(cubin: Path, rows="rows", groups="groups", copies=4, hash_cols=24, heads=64, seqs="seqs", peers=None):
    ...
    ops.update({
        ...
        "metadata": op("metadata", "out buffer<i32>;out buffer<i32>;out buffer<i64>;out buffer<i64>;out buffer<u8>;out buffer<i32>;out buffer<i32>;out buffer<i32>;out buffer<i32>;out buffer<i32>;out buffer<i32>;out buffer<i32>;in buffer<i32>;in buffer<i64>;in buffer<i32>;in buffer<i64>;in buffer<i32>;in buffer<i32>;in buffer<i32>;i32;i32;i32;i32", [{"ceil_div": [rows, 256]}, 1, 1]),
        ...
        "window_indices": op("window_indices", "out buffer<i32>;in buffer<i32>;in buffer<i32>;in buffer<i32>;in buffer<i32>;i32;i32;i32;i32;i32;i32", [rows, 1, 1]),
