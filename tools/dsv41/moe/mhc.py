...
def pieces(rows='tokens', cubin_dir=None, max_tokens=8192, *, fp8, shared_rows=None):
    ...
    entry=f"_ZN9deep_gemm19sm100_mega_mhc_implILj5120ELj16ELj152ELb1ELb1ELb1ELj{0 if fp8 == 'gemm' else 16}EEEv14CUtensorMap_stS1_S1_S1_S1_S1_S1_S1_NS_6layout8mega_mhc7MixArgsENS3_8NormArgsEPvPm"
