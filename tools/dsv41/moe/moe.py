...
def pieces(experts=384,cubin_dir=None,rows="tokens"):
 ...
 op={'params':params,'impl':{'launches':[{'module':'dsv41_mega_moe','entry':f'dsv41_mega_moe_e{experts}_r4','params':params[:5]+['bytes<128>']*18,'args':[{'param':i} for i in range(5)]+maps(5,lay['ring'],lay['sf_ring'],local,'u4')+maps(13,8192,lay['shared_sf_rows'],1,'u8'),'block':[512,1,1],'grid':[152,1,1],'cluster':[2,1,1],'shared_mem':lay['smem']}]}}
