...
#include <cstdio>
#include <cstdlib>
template<int E,int K,int R>void dump(){using C=dsv41::Config<E,K,R>;using namespace deep_gemm;auto b=layout::MegaMoEBuffer(nullptr,5120,2304,R,E,8192,K,C::Ring,C::SfRing,true,1);
...
int main(int argc,char**argv){if(argc!=2)return 2;int e=atoi(argv[1]);if(e==384)dump<384,6,4>();else if(e==128)dump<128,3,4>();else return 2;}
